...
public class UserController {
    private static final Logger log = LoggerFactory.getLogger(UserController.class);    private final UserRepository userRepository;
    ...
    public ResponseEntity<?> registerAlternative(@RequestBody RegisterRequest request) {
        ...
        try {
            ...
            log.info("Usuario creado exitosamente: {}", savedUser.getUsername());            if ("medico".equalsIgnoreCase(roleName)) {
                try {
